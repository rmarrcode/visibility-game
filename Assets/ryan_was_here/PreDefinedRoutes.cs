...
public class PreDefinedRoutes
{
    ...
    // int[][] routes = new int[][]
    // {
    //     new int[] {4, 4, 4, 4, 4, 4, 4, 1, 1, 1, 1, 1, 4},                
    //     new int[] {4, 4, 4, 4, 4, 4, 4, 4, 4, 1, 1, 1, 1, 4},                
    //     new int[] {4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 1, 1, 4},                
    //     //new int[] {1, 1, 3, 1} 
    // };

    int[][] routes = new int[][]
    {
        new int[] {2, 2, 2, 2, 2, 2, 2, 3, 3, 3, 3, 3, 3, 3, 1, 1, 4, 4},                
        new int[] {2, 2, 2, 2, 2, 2, 2, 3, 3, 3, 3, 3, 3, 3, 3, 3, 1, 1, 1, 1, 4, 4, 4, 4},                
        new int[] {2, 2, 2, 2, 2, 2, 2, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 1, 1, 1, 1, 1, 1, 4, 4, 4, 4, 4, 4},                
        //new int[] {1, 1, 3, 1} 
    };
